      ...
      <div className="relative mx-auto max-w-xl">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-6 text-gray-500">
            If any of this seems interesting or something that would be helpful
            for you please get in touch. The most useful message would be if you
            could outline the solution you are interested in and why. If you are
            unsure which solution is best for you then a good explanation of the
            problem your facing will help us have a more productive exhange.
          </p>
        </div>
